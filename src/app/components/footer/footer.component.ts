    ...
    <footer class="footer">
        ...
        <div class="container">
          <div class="footer-grid">
            ...
            <div class="footer-brand">
              ...
              <p>
                Développeur Full-Stack passionné, basé à Abidjan. Je construis
                des solutions digitales innovantes pour l'Afrique.
              </p>
              <div class="footer-socials">
                ...
                <a
                  href="https://www.linkedin.com/in/yao-jean-francis-amani-44a96629a/"
                  class="social-link"
                >
                  <i class="pi pi-linkedin"></i>
                </a>
                <a href="https://github.com/francisyao8" class="social-link">
            ...
            <div class="footer-links">
              ...
              <ul>
                <li *ngFor="let item of navItems">
                  <a (click)="scrollTo(item.anchor)" style="cursor:pointer">{{
                    item.label
                  }}</a>
                </li>
              </ul>
            ...
            <div class="footer-contact">
              ...
              <div class="contact-lines">
                ...
                <p>
                  <i class="pi pi-map-marker"></i> Riviera Bonoumin, Abidjan
                </p>
              </div>
              <a
                href="assets/cv/cv_francis_amani.pdf"
                download
                class="btn-primary footer-dl"
              >
      ...
      <div class="footer-bottom">
        <div class="container">
          ...
          <p>
            Construit avec <strong>Angular</strong> + <strong>PrimeNG</strong> ❤
          </p>
        </div>
      </div>
    </footer>
